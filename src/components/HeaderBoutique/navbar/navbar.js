  ...
  return (
    <Navigation classname="text-white">
      ...
      <div className="flex flex-wrap container justify-between mx-auto p-2">
        ...
        {navbarOpen ? (
          <Navbox>
            <img className='w-3/6 md:hidden mx-auto mt-5 mb-5 ' alt="accueil" src="https://res.cloudinary.com/anthow/image/upload/v1619966610/Coccinelles%20et%20compagnies/logo-boutique_bgsvny.svg" />
            <Cart className="gris" />
            <NavbarLinks />
            <Search/>
          </Navbox>
