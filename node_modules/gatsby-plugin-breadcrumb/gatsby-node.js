...
exports.onCreatePage = function (_ref, pluginOptions) {
  ...
  if (pluginOptions.useAutoGen) {
    ...
    var _optionsActual$crumbL = optionsActual.crumbLabelUpdates,
        ...
        excludeOptions = optionsActual.excludeOptions; // for pages not excludecd, create crumbs out of each section of the page path
    ...
    if (!isMatch(page.path)) {
      ...
      splitUrl.forEach(function (split, index) {
        if (index === 0 && split === '') {
          ...
          acc += "/" + split; // update crumbLabel for any crumbLabelUpdates otherwise use path
